...
cardView1.setOnClickListener(new View.OnClickListener() {
    public void onClick(View v) {
        ...
        cardView4.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
                ...
                FragmentManager fragmentManager = getActivity().getSupportFragmentManager();
                FragmentTransaction fragmentTransaction = fragmentManager.beginTransaction();
                fragmentTransaction.replace(R.id.homeFragment, new OthersInterface());
                fragmentTransaction.addToBackStack(null);
                fragmentTransaction.commit();
            }
        });;
    ...
    private void openMarketInterface() {
        Intent intent=new Intent(getContext(),  marketInterface.class);
        startActivity(intent);

      /*  Intent intent = new Intent(this, marketInterface.class );
        startActivity(intent);*/
    }

    private void openHouseInterface() {
        /*Intent intent = new Intent(this, houseInterface.class );
        startActivity(intent);*/

    }

    private void openOfficeInterface() {

    }

    private void openOthersInterface( ){
